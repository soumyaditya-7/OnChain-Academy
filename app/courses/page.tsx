...
export default function CoursesPage() {
  ...
  useEffect(() => {
    if (writeError) {
      ...
      const errorStr = writeError.message || ""

      if (errorStr.includes("Already purchased")) {
        errorMessage = "You already own this course!"
      } else if (errorStr.includes("insufficient funds") || errorStr.includes("exceeds balance")) {
        errorMessage = "Insufficient wallet balance. You need more ETH."
